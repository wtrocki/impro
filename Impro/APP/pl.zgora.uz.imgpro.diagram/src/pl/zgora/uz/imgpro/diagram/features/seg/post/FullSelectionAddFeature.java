...
public class FullSelectionAddFeature extends AbstractAddFeature {

    public FullSelectionAddFeature(IFeatureProvider fp) {
	super(fp);
    }
	...
	if (newObject instanceof FullSelection) {
	...
	return ImproImageProvider.IMG_FULL_SELECTION;
    }
}
