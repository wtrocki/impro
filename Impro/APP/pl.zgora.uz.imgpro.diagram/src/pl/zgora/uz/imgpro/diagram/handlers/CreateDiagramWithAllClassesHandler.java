 ...
 *******************************************************************************/
package pl.zgora.uz.imgpro.diagram.handlers;
...
import pl.zgora.uz.imgpro.diagram.Messages;
...
public final class CreateDiagramWithAllClassesHandler extends AbstractHandler {
	...
	public Object execute(final ExecutionEvent event) throws ExecutionException {
		...
		try {
			...
			IStatus status = new Status(IStatus.ERROR, "pl.zgora.uz.imgpro.diagram", e.getMessage(), e); //$NON-NLS-1$
