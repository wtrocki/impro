...
public class VignettingAddFeature extends AbstractAddFeature {

    public VignettingAddFeature(IFeatureProvider fp) {
	super(fp);
    }
	...
	if (newObject instanceof Vignetting) {
	...
	return ImproImageProvider.IMG_VIGNETTING;
    }
}
