...
public class ImagePreviewAddFeature extends AbstractAddFeature {

    public ImagePreviewAddFeature(IFeatureProvider fp) {
	super(fp);
    }
	...
	if (newObject instanceof ImagePreview) {
	...
	return ImproImageProvider.IMG_SHOW_IMG;
    }
