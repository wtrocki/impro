...
public class SegCLNAddFeature extends AbstractAddFeature {

    public SegCLNAddFeature(IFeatureProvider fp) {
	super(fp);
    }
	...
	if (newObject instanceof SegCLN) {
	...
	return ImproImageProvider.getHashImageForClass(SegCLN.class);
    }
