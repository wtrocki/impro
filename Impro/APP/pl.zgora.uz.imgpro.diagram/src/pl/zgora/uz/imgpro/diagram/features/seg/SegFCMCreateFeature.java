...
public class SegFCMCreateFeature extends AbstractImProCreateFeature {

    public SegFCMCreateFeature(IFeatureProvider fp) {
	// set name and description of the creation feature
	super(fp, SegFCM.class.getSimpleName(), "Fuzzy c-means based segmentation"); //$NON-NLS-1$ //$NON-NLS-2$
    }

    
    public DiagramElement createElement() {
	return DiagramFactory.eINSTANCE.createSegFCM();
    }
}
