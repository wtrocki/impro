...
public class SegKMOffCreateFeature extends AbstractImProCreateFeature {

    public SegKMOffCreateFeature(IFeatureProvider fp) {
	// set name and description of the creation feature
	super(fp, SegKMOff.class.getSimpleName(), "k-means off line based segmentation"); //$NON-NLS-1$ //$NON-NLS-2$
    }

    
    public DiagramElement createElement() {
	return DiagramFactory.eINSTANCE.createSegKMOff();
    }
}
