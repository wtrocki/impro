...
public class HistStretchAddFeature extends AbstractAddFeature {

    public HistStretchAddFeature(IFeatureProvider fp) {
	super(fp);
    }
	...
	if (newObject instanceof HistStretch) {
	...
	return ImproImageProvider.IMG_HISTOGRAM;
    }
