...
public class SegCLNCreateFeature extends AbstractImProCreateFeature {

    public SegCLNCreateFeature(IFeatureProvider fp) {
	// set name and description of the creation feature
	super(fp, SegCLN.class.getSimpleName(), "Competitive lerning networks based segmentation"); //$NON-NLS-1$ //$NON-NLS-2$
    }

    
    public DiagramElement createElement() {
	return DiagramFactory.eINSTANCE.createSegCLN();
    }
}
