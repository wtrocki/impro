...
public class ExtractAddFeature extends AbstractAddFeature {

    public ExtractAddFeature(IFeatureProvider fp) {
	super(fp);
    }
	...
	if (newObject instanceof ExtractFeatures) {
	...
	return ImproImageProvider.IMG_EXTRACTION;
    }
