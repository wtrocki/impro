...
public class SegATCreateFeature extends AbstractImProCreateFeature {

    public SegATCreateFeature(IFeatureProvider fp) {
	// set name and description of the creation feature
	super(fp, SegAT.class.getSimpleName(), "Adaptive thresholding segmentation"); //$NON-NLS-1$ //$NON-NLS-2$
    }

    
    public DiagramElement createElement() {
	return DiagramFactory.eINSTANCE.createSegAT();
    }
}
