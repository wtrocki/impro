...
public class FullSelectionCreateFeature extends AbstractImProCreateFeature {

    public FullSelectionCreateFeature(IFeatureProvider fp) {
	// set name and description of the creation feature
	super(fp, FullSelection.class.getSimpleName(), "Full selection"); //$NON-NLS-1$ //$NON-NLS-2$
    }

    
    public DiagramElement createElement() {
	return DiagramFactory.eINSTANCE.createFullSelection();
    }
}
