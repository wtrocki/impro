...
public class SegATAddFeature extends AbstractAddFeature {

    public SegATAddFeature(IFeatureProvider fp) {
	super(fp);
    }
	...
	return ImproImageProvider.getHashImageForClass(SegAT.class);
    }
