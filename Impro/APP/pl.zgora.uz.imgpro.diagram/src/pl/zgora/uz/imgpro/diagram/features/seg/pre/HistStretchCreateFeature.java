...
public class HistStretchCreateFeature extends AbstractImProCreateFeature {

    public HistStretchCreateFeature(IFeatureProvider fp) {
	// set name and description of the creation feature
	super(fp, HistStretch.class.getSimpleName(), "Stretch image histogram"); //$NON-NLS-1$ //$NON-NLS-2$
    }

    
    public DiagramElement createElement() {
	return DiagramFactory.eINSTANCE.createHistStretch();
    }
}
