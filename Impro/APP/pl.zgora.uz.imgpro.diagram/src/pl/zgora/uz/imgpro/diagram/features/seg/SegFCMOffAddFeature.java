...
public class SegFCMOffAddFeature extends AbstractAddFeature {

    public SegFCMOffAddFeature(IFeatureProvider fp) {
	super(fp);
    }
	...
	if (newObject instanceof SegFCMOff) {
	...
	return ImproImageProvider.getHashImageForClass(SegFCMOff.class);
    }
