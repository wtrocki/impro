...
public class SegKMCreateFeature extends AbstractImProCreateFeature {

    public SegKMCreateFeature(IFeatureProvider fp) {
	// set name and description of the creation feature
	super(fp, SegKM.class.getSimpleName(), "k-means based segmentation"); //$NON-NLS-1$ //$NON-NLS-2$
    }

    
    public DiagramElement createElement() {
	return DiagramFactory.eINSTANCE.createSegKM();
    }
}
