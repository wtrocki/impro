...
public class CustomElementAddFeature extends AbstractAddFeature {

    public CustomElementAddFeature(IFeatureProvider fp) {
	super(fp);
    }
	...
	if (newObject instanceof CustomElement) {
	...
	return ImproImageProvider.IMG_COMMON;
    }
