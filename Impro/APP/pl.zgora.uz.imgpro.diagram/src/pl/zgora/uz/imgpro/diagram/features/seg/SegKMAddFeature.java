...
public class SegKMAddFeature extends AbstractAddFeature {

    public SegKMAddFeature(IFeatureProvider fp) {
	super(fp);
    }
	...
	return ImproImageProvider.getHashImageForClass(SegKM.class);
    }
