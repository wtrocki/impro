...
public class CropAddFeature extends AbstractAddFeature {

    public CropAddFeature(IFeatureProvider fp) {
	super(fp);
    }
	...
	return ImproImageProvider.IMG_CROP;
    }
