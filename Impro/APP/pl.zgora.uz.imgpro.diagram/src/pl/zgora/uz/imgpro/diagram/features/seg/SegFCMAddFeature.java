...
public class SegFCMAddFeature extends AbstractAddFeature {

    public SegFCMAddFeature(IFeatureProvider fp) {
	super(fp);
    }
	...
	if (newObject instanceof SegFCM) {
	...
	return ImproImageProvider.getHashImageForClass(SegFCM.class);
    }
