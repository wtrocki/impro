...
public class CollapseDiagramElementFeature extends AbstractCustomFeature {

    public CollapseDiagramElementFeature(IFeatureProvider fp) {
	super(fp);
    }
	...
	return "xC&ollapse Figure"; //$NON-NLS-1$
	...
	if (containerShape != null && containerShape.length == 1) {
	    ...
	    containerGa.setHeight(LayoutDiagramElementFeature.MIN_HEIGHT);
	    layoutPictogramElement(containerShape[0]);
	    ShapePropertyService.setCollapsed(containerShape[0], true);
	}
    }
