...
public class SegKMOffAddFeature extends AbstractAddFeature {

    public SegKMOffAddFeature(IFeatureProvider fp) {
	super(fp);
    }
	...
	return ImproImageProvider.getHashImageForClass(SegKMOff.class);
    }
