function [wynik] = ikona( segIm )
    %figure(1);
    %funkcja segmentuje wybrany z rogów w celu okreœlenia figury
    %okreslenie figury odbywa siê poprzez sprawdzenie cech takich jak: obszar, wype³nienie obszaru, stosunek wysokoœci z czerokoœci¹
    % 1 - kwadrat
    % 2 - trojkat
    % 3 - kolo
    % 4 - deltoid
