...
package com.matlab.eclipse.meditor;
...
import com.matlab.eclipse.meditor.util.ColorEditor;
...
public class MatlabenginePrefsPage extends AbstractMatlabenginePrefsPage {
    ...
    public static final RGB DEFAULT_MATCHING_BRACKETS_COLOR = new RGB(64, 128,
	    128);
    ...
    private static final RGB DEFAULT_COMMENT_COLOR = new RGB(121, 121, 121);

    private static final RGB DEFAULT_PREFERENCE_COLOR_BACKGROUND = new RGB(255,
	    255, 255);
    public static final boolean DEFAULT_EDITOR_BACKGROUND_COLOR_SYSTEM_DEFAULT = true;
    private static final RGB DEFAULT_EDITOR_CURRENT_LINE_COLOR = new RGB(244,
	    255, 255);
    public static final RGB DEFAULT_EDITOR_LINE_NUMBER_RULER_COLOR = new RGB(0,
	    0, 0);
    public static final RGB DEFAULT_EDITOR_PRINT_MARGIN_COLOR = new RGB(192,
	    192, 192);
	...
	overlayKeys.add(new OverlayPreferenceStore.OverlayKey(
		OverlayPreferenceStore.INT, TAB_WIDTH));
	overlayKeys
	...
	// matching
	overlayKeys.add(new OverlayPreferenceStore.OverlayKey(
		OverlayPreferenceStore.BOOLEAN, USE_MATCHING_BRACKETS));
	overlayKeys.add(new OverlayPreferenceStore.OverlayKey(
		OverlayPreferenceStore.STRING, MATCHING_BRACKETS_COLOR));

	// checkbox
	overlayKeys.add(new OverlayPreferenceStore.OverlayKey(
		OverlayPreferenceStore.BOOLEAN, SUBSTITUTE_TABS));
	overlayKeys
		.add(new OverlayPreferenceStore.OverlayKey(
	...
	// colors
	overlayKeys.add(new OverlayPreferenceStore.OverlayKey(
		OverlayPreferenceStore.STRING, CODE_COLOR));
	overlayKeys.add(new OverlayPreferenceStore.OverlayKey(
		OverlayPreferenceStore.STRING, NUMBER_COLOR));
	overlayKeys.add(new OverlayPreferenceStore.OverlayKey(
		OverlayPreferenceStore.STRING, KEYWORD_COLOR));
	overlayKeys.add(new OverlayPreferenceStore.OverlayKey(
		OverlayPreferenceStore.STRING, FUNCTION_COLOR));
	overlayKeys.add(new OverlayPreferenceStore.OverlayKey(
		OverlayPreferenceStore.STRING, TOOLBOX_COLOR));
	overlayKeys.add(new OverlayPreferenceStore.OverlayKey(
		OverlayPreferenceStore.STRING, STRING_COLOR));
	overlayKeys.add(new OverlayPreferenceStore.OverlayKey(
		OverlayPreferenceStore.STRING, COMMENT_COLOR));
	overlayKeys.add(new OverlayPreferenceStore.OverlayKey(
	...
	addTextField(
		...
		AbstractDecoratedTextEditorPreferenceConstants.EDITOR_PRINT_MARGIN_COLUMN,
		3, 0, true);
	addCheckBox(appearanceComposite, "Substitute spaces for tabs?",
		SUBSTITUTE_TABS, 0);
	addCheckBox(
		appearanceComposite,
		"Show overview ruler",
	...
	Button master = addCheckBox(
		appearanceComposite,
		"Use custom caret",
		AbstractDecoratedTextEditorPreferenceConstants.EDITOR_USE_CUSTOM_CARETS,
		0);

	Button slave = addCheckBox(
		appearanceComposite,
		"Enable thick caret",
		AbstractDecoratedTextEditorPreferenceConstants.EDITOR_WIDE_CARET,
		0);
	...
	prefs.setDefault(
		AbstractDecoratedTextEditorPreferenceConstants.EDITOR_LINE_NUMBER_RULER_COLOR,
		StringConverter
			.asString(DEFAULT_EDITOR_LINE_NUMBER_RULER_COLOR));
	prefs.setDefault(
		AbstractDecoratedTextEditorPreferenceConstants.EDITOR_PRINT_MARGIN_COLOR,
	...
	prefs.setDefault(
		AbstractDecoratedTextEditorPreferenceConstants.EDITOR_SELECTION_FOREGROUND_DEFAULT_COLOR,
		StringConverter
			.asString(DEFAULT_EDITOR_SELECTION_FOREGROUND_DEFAULT_COLOR));

	// no UI
	prefs.setDefault(CONNECT_TIMEOUT, DEFAULT_CONNECT_TIMEOUT);
	prefs.setDefault(RUN_MANY_SCRIPT_LOCATION,
		DEFAULT_RUN_MANY_SCRIPT_LOCATION);
    }
