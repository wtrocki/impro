...
public class Activator extends AbstractUIPlugin implements Preferences.IPropertyChangeListener  {
    ...
    public static ImageDescriptor getImageDescriptor(String path) {
        return AbstractUIPlugin.imageDescriptorFromPlugin("com.matlab.eclipse.meditor", path);
    }
            ...
            public void run() {
                ...
                if (shell != null) {
                    ...
                    ErrorDialog.openError(
                            shell, "Matlab editor error", "Error logged from com.matlab.eclipse", status);
                }
            }
        });
     } 
        ...
        disp.asyncExec(new Runnable() {
            public void run() {
                ...
                if (shell != null) {
                    ...
                    ErrorDialog.openError(
                        shell, "Matlab editor warning", "Warning from com.matlab.eclipse:", status);
                }
            }
        });
     } 
